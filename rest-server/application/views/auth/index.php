...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?= base_url('rest-server') ?>/assets/images/favicon/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?= base_url('rest-server')  ?>/assets/images/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url('rest-server')  ?>/assets/images/favicon/favicon-16x16.png">
    <link rel="mask-icon" href="<?= base_url('rest-server')  ?>/assets/images/favicon/safari-pinned-tab.svg" color="#5bbad5">
      ...
      <div class="shadow-lg rounded p-4 p-sm-5 bg-white form">
        ...
        <form class="mt-4" method="post">
          <div class="form-group">
            ...
            <input type="email" class="form-control form-control-light" id="login-email" placeholder="name@email.com" name="email">
            <?= form_error('email', '<small class="text-danger pl-3">', '</small>'); ?>
          </div>
          <div class="form-group">
            <label for="login-password" class="form-label form-label-light d-flex justify-content-between align-items-center">
              Password
              <a href="./forgot-password.html" class="text-muted small ms-2 text-decoration-underline">Lupa
                password?</a>
            </label>
            <input type="password" class="form-control form-control-light" id="login-password" placeholder="Password" name="password">
        ...
        <p class="d-block text-center text-muted small">Belum Punya Akun? <a class=" text-decoration-underline"
            href="<?= base_url('rest-server/auth/registrasi') ?>">Daftar</a></p>
      </div>
    </div>
    <!-- / Login Form-->
